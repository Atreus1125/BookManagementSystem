...
public class MFindPasswordFrame extends JFrame {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MFindPasswordFrame frame = new MFindPasswordFrame();
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				if(!textField_1.getText().isEmpty() && !textField_2.getText().isEmpty() && !textField_3.getText().isEmpty() && !textField_4.getText().isEmpty())
				{
					...
					if(rdao.findByRnoRnameRsexRdept(Integer.valueOf(textField_1.getText()), textField_2.getText(), textField_3.getText(), textField_4.getText()) != null)
					{
						JOptionPane.showMessageDialog(getContentPane(), "密码找回成功");
						textField_5.setText(rdao.findByRnoRnameRsexRdept(Integer.valueOf(textField_1.getText()), textField_2.getText(), textField_3.getText(), textField_4.getText()).getRpassword());
					}
					else
					{
						JOptionPane.showMessageDialog(getContentPane(), "信息有误");
					}	
				}
				else
				{
						JOptionPane.showMessageDialog(getContentPane(), "编号、姓名、性别、专业均不能为空");
				}
